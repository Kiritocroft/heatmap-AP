...
export function SignalLegend() {
    return (
        <div className="absolute bottom-4 right-4 bg-slate-900/95 backdrop-blur-sm p-4 rounded-lg shadow-2xl border border-slate-700 pointer-events-none w-48">
            ...
            {/* Color Gradient Bar */}
            <div className="h-2 w-full rounded-full bg-gradient-to-r from-blue-600 via-green-500 via-yellow-400 to-red-600 mb-2"></div>
            ...
            <div className="flex flex-col gap-2.5">
                ...
                <div className="flex items-center gap-3">
                    <div className="w-2.5 h-2.5 rounded-full shadow-[0_0_8px_rgba(59,130,246,0.8)] bg-[#3b82f6]"></div>
